...
The app runs **without any API keys or network** by falling back to seeded demo data
(a fictional Utah-County taco truck) — demo mode must survive airplane mode.
